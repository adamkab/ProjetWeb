  ...
  return (
    <div>
      <header className="text-center mb-10">
        ...
        <h2 className="text-3xl font-semibold text-gray-600 mt-4">Adam Kabouri</h2>
        <img 
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600"><strong>Nom:</strong> Kabouri</p>
        <p className="text-gray-600"><strong>Prénom:</strong> Adam</p>
      ...
      <footer className="mt-10 text-center">
        <p className="text-gray-600"><strong>Édité par:</strong> Adam Kabouri</p>
